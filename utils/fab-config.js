...
const fabPageActions = {
    // Global actions appear on EVERY page. 
    // We leave this empty now so WhatsApp/Email don't show up for logged-in users on private pages.
    global: [],

    // Public Pages Configuration (Login, Home, Tracking, etc.)
    'login.html': [
        {
            label: 'WhatsApp',
